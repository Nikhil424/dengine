require 'chef/knife'
require "#{File.dirname(__FILE__)}/dengine_azurerm_base"
require 'securerandom'
require "#{File.dirname(__FILE__)}/dengine_azure_common_bootstrap_options"
require "#{File.dirname(__FILE__)}/dengine_azure_bootstrapper"
require "#{File.dirname(__FILE__)}/dengine_azure_ip_attributes"
