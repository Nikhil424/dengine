...
module Azure
  class ResourceManagement
    class ARMInterface < DengineAzureInterface
      ...
      def delete_networkinterface(resource_group_name,vm_name)
        network_resource_client.network_interfaces.delete(resource_group_name, vm_name, custom_headers = nil)
      end

      def delete_public_ip(resource_group_name,vm_name)
        network_resource_client.public_ipaddresses.delete(resource_group_name, vm_name, custom_headers = nil)
      end
